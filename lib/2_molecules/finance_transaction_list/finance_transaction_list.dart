              ...
              builder: (context) {
                return AlertDialog(
                  ...
                  content: Column(
                    ...
                    children: [
                      FinanceText.p16(transactionsByMonth[index].category),
                      ...
                      const SizedBox(height: 10),
                      FinanceText.p14(transactionsByMonth[index].description),
                      FinanceText.p12(transactionsByMonth[index].method),
                      FinanceText.p12(
